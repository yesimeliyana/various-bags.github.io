	...
	<div class="row">
		...
		if(isset($_POST['checkout'])){
			if($_SERVER['REQUEST_METHOD'] == "POST"){
				if(empty($_POST['name'])){
					$error = true;
					$nameErr = "Masukkan nama pertama Anda";
				}else{
					$name = $_POST['name'];
				...
				if(empty($_POST['email'])){
					$error = true;
					$emailErr = "Masukkan alamat email Anda";
				}else{
					$email = $_POST['email'];
				...
				if(empty($_POST['address'])){
					$error = true;
					$addressErr = "Masukkan  alamat Anda";
				}else{
				...
				if(empty($_POST['city'])){
					$error = true;
					$cityErr = "Masukkan  nama kota atau kabupaten";
				}else{
					$city = $_POST['city'];
				...
				if(empty($_POST['state'])){
					$error = true;
					$stateErr = "Masukkan nama provinsi";
				}else{
					$state = $_POST['state'];
				...
				if(empty($_POST['phone'])){
					$error = true;
					$phoneErr = "Masukkan nomor telepon Anda";
				}else{
					$phone = $_POST['phone'];
				}
				...
				if(empty($_POST['owner'])){
					$error = true;
					$ownerErr = "Masukkan  nama pemilik Anda";
				}else{
					$owner = $_POST['owner'];
				...
				if(empty($_POST['card_number'])){
					$error = true;
					$cardnumberErr = "Masukkan  nomor rekening Anda";
				}else{
				...
				if(empty($_POST['pay'])){
					$error = true;
					$payErr = "Masukkan total pembayaran";
				}else{
					$pay = $_POST['pay'];
					if(!is_numeric($pay)){
						$error = true;

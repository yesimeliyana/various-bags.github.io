...
<div class="footer-top">
	<div class="container">
		<div class="col-lg-3 footer-grid">
			<h3>Tentang Kami</h3>
			<p>Various Bags merupakan toko belanja online yang menyediakan berbagai macam tas fashion wanita. 
			   Toko kami bergerak di bidang fashion khususnya fashion tas dan toko kami menjual berbagai macam tas.</p>
		</div>
		<div class="col-lg-3 footer-grid">
			<h3>Menu</h3>
		...
		<div class="col-lg-3 footer-grid">
			...
			<div class="contact-grid">
				...
				<div class="contact1">
					<h3>Alamat Pusat</h3>
					<p> Jl.Tk Pertiwi RT.37 RW.06 Ds Mulyo Sari Kec. Pasir Sakti
						Kab. Lampung Timur 34387
					</p>
				</div>
...
<div class="footer-bottom">
	<div class="container-fluid">
		...
		<p class="footer-bottom-right">&copy; 2022 Various Bags. All Rights Reserved | Design by <a href="/variousbags/">Divas</a></p>
		<div class="clearfix"></div>
	</div>
</div>

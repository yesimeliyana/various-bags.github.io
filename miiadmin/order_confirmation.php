...
<head>
	...
	<title>Various Bags | Pesanan</title>
...
<body>
					...
					<div class="row" style="margin-bottom: 10px;">
						<div class="col-lg-12" style="margin-bottom:40px;">
							...
							<div class="col-lg-12">
								...
								<div style="margin-top:3%;"><p>Terima kasih atas pembelian Anda di variousbags, kami senang bahwa Anda telah memilih berbelanja dengan variousbags dan kami berharap dapat melayani Anda kembali.</p></div>
							</div>
						</div>
				</div>
			</div>
	...
	<footer class="footer-bottom">
		<div class="footer-right">
			&copy; 2022 variousbags. All Rights Reserved | Design by Divas
		</div>
		<div class="clearfix"></div>
	</footer>

<div class="container">
	<h1 class="well"><center>Pendaftaran Various Bags</center></h1>
			...
			if(isset($_POST['signup'])){
				...
				if($_SERVER['REQUEST_METHOD'] == "POST"){
					if(empty($_POST['fname'])){
						$error = true;
						$fnameErr = "Masukan nama pertama Anda";
					}else{
						$fname = $_POST['fname'];
					...
					if(empty($_POST['lname'])){
						$error = true;
						$lnameErr = "Masukan nama terakhir Anda";
					}else{
						$lname = $_POST['lname'];
					...
					if(empty($_POST['address'])){
						$error = true;
						$addressErr = "Masukan alamat Anda";
					}else{
					...
					if(empty($_POST['city'])){
						$error = true;
						$cityErr = "Masukan nama kota atau kabupaten";
					}else{
						$city = $_POST['city'];
					...
					if(empty($_POST['state'])){
						$error = true;
						$stateErr = "Masukan nama  provinsi";
					}else{
							$state = $_POST['state'];
					...
					if(empty($_POST['phone'])){
						$error = true;
						$phoneErr = "Masukan nomor telepon";
					}else{
						$phone = $_POST['phone'];
						if(!is_numeric($phone)){
							$error = true;
					...
					if(empty($_POST['email'])){
						$error = true;
						$emailErr = "Masukan alamat email Anda";
					}else{
						$email = $_POST['email'];
					...
					if(empty($_POST['cpass'])){
						$error = true;
						$cpassErr = "Masukan konfirmasi kata sandi";
					}else{
